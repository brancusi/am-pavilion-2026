(ns amp.components.sections.curators-section
  (:require
...
(defnc curators-section
  ...
  (let [ref (hooks/use-ref "curators-ref")
    ...
    (d/section
     ...
     (when title
       (d/h2 {:class "font-mono font-extrabold uppercase tracking-wider
